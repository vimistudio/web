  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 text-center">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 px-4">Let's Create Something Remarkable</h1>
        <div className="flex flex-col items-center justify-center mb-8 px-4">
          ...
          <p className="text-lg sm:text-xl">New spots open for {currentMonth}.</p>
        </div>
